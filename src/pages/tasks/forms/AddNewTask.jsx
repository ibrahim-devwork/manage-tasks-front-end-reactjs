...
import { createTask } from '../../../store/tasks/taskActions';

const AddNewTask = ({filter, setFilter}) => {
    ...
    return (
        <div>
            <button className='add-new-btn btn btn-primary' data-toggle="modal" data-target="#add-new-task">
                <i className="nav-icon fas fa-plus"></i>
                <span> </span>
                    Add new
            </button>

            <div className="modal fade" id="add-new-task">
